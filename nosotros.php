...
<body>
    ...
    <!-- Portada -->
    <section id="imageContainer" class="min-w-full h-[40vh] flex justify-center items-center relative">
        <img id="image1" class="active object-cover" src="./images/nuestroequipo.jpg" alt="Imagen Cambiante" />
    </section>

    <!-- Intro -->
    <section class="flex flex-col p-8 px-8 gap-6">
        <h4 class="text-center text-lg font-medium font-['Oswald']">¡Te damos la bienvenida a un mundo de melodías unidas!</h4>
        <div class="flex flex-col gap-8">
            ...
            <video width="640" height="360" controls autoplay loop muted class="shadow-lg">
    ...
    <section class="flex flex-col p-8 px-8">
        <div>
            <h3 class="text-black font-['Oswald'] text-center text-lg">Razones para elegir Melodías Unidas</h3>
        </div>
        <div class="flex justify-center items-center flex-col pt-8 gap-10">
            <div class="flex justify-center items-start flex-col max-w-[340px] gap-4" data-aos="fade-up" data-aos-duration="1000">
                <h5 class="font-[Oswald] text-lg text-black/90 bg-secondary-color text-start px-4 py-2">
                    Talento y devoción musical
                </h5>
                <p class="text-justify text-[11.5px]">
