...
<body>
  ...
  <!-- Portada -->
  <section id="imageContainer" class="min-w-full h-[40vh] sm:h-[56vh] lg:h-[85vh] border-primary-color flex justify-center items-center relative">
    ...
    <div class="absolute z-10 top-12 px-12 animate__animated animate__backInDown animate__delay-1s sm:px-40 lg:px-60 lg:top-24">
      <p class="text-white text-center font-bold sm:text-xl lg:text-2xl xl:text-3xl">
  ...
  <section class="hidden lg:flex p-8 py-16 w-full justify-center items-center flex-col gap-4 mb-6 sm:px-16 lg:px-48">
    ...
    <div class="flex flex-row gap-8 max-px-16 xl:max-w-[1920px]">
      ...
      <div class="flex w-full flex-col justify-center items-center gap-4">
        ...
        <div class="flex justify-center items-center pt-4">
          <a href="#" class="bg-primary-color rounded-full px-6 py-2 flex justify-center items-center text-white font-['Oswald'] text-xl">Conoceme mas</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="flex p-8 py-16 w-full justify-center items-center flex-col gap-8 bg-[#272727] mt-8 sm:px-32 lg:px-48 lg:flex-row lg:gap-16 lg:py-24">
    <div class="flex justify-center items-center flex-col gap-6 lg:max-w-[300px]">
      <div class="flex justify-center items-center w-[120px] h-[120px] lg:w-[150px] lg:h-[150px] rounded-full" data-aos="zoom-in" data-aos-duration="1000">
      ...
      <p class="text-sm text-[#73aed9] lg:text-base">Verónica Metakovskaya</p>
    </div>
  ...
  <section class="flex p-8 w-full justify-center items-center flex-col gap-4 sm:px-32 lg:px-48 lg:py-0 xl:py-12">
  ...
  <section class="flex p-8 pt-0 w-full justify-center items-center flex-col gap-4 sm:px-32 lg:px-48 lg:py-12 xl:py-0 xl:mb-12">
    <div class="flex flex-wrap gap-4 lg:gap-6 justify-center sm:justify-between lg:justify-between lg:max-w-[1200px]">
      <video class="w-[300px] h-[160px] sm:w-[225px] lg:w-[300px] xl:w-[270px] shadow-md bg-black/80 opacity-85 hover:opacity-100" controls class="shadow-lg">
  ...
  <section class="flex p-8 py-16 pt-8 w-full justify-center items-center flex-col sm:px-32 lg:px-48" id="contacto">
    <form action="" class="flex flex-col gap-4 w-full sm:max-w-[520px] lg:max-w-[800px]">
      <h5 class="font-['Oswald'] text-lg lg:text-2xl">Escribenos</h5>
      <input type="text" placeholder="Ingresa tu correo" class="w-full border border-primary-color rounded-sm px-2 py-2 text-sm lg:text-base" required>
      <input type="text" placeholder="Ingresa tu numero" class="w-full border border-primary-color rounded-sm px-2 py-2 text-sm lg:text-base" required>
      <textarea name="content" id="content" placeholder="Dejanos un mensaje" rows="6" class="w-full border border-primary-color rounded-sm px-2 py-1 text-sm lg:text-base"></textarea>
      <button class="bg-secondary-color text-black/80 px-2 py-2 rounded-sm font-['Oswald'] text-lg lg:text-2xl lg:py-3">Enviar</button>
    </form>
  </section>
  ...
  <footer class="flex flex-col p-8 py-14 gap-6 w-full justify-center items-center bg-primary-color" id="footer">
    <div class="w-full flex justify-center items-center gap-4">
      <a href="https://www.facebook.com/profile.php?id=61559635380871" class="cursor-pointer" title="Facebook" alt="Facebook">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook text-white w-[24px] h-[24px] lg:w-[32px] lg:h-[32px]" viewBox="0 0 16 16">
          <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" />
        </svg>
      </a>
      <a href="mailto:melodiaunidas@gmail.com?Subject=Quiero%20información%20de%20las%20clases" class="cursor-pointer" title="Contactar por email" alt="Contactar por email">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-at-fill text-white w-[24px] h-[24px] lg:w-[32px] lg:h-[32px]" viewBox="0 0 16 16">
    ...
    <div class="flex w-full justify-center items-center">
      <h5 class="flex flex-col justify-start items-center text-white text-[12px] gap-2">
        <b class="text-sm lg:text-base">Horario de atencion:</b>
        <span class="flex justify-start items-center text-white text-[12px] lg:text-base">
          09:00-14:00 / 15:30-20:20
        </span>
      </h5>
    </div>
    <div class="w-full flex justify-evenly sm:justify-center gap-2 sm:gap-16 items-center text-white">
      <div class="flex gap-1 justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 lg:size-7">
          <path fill-rule="evenodd" d="m11.54 22.351.07.04.028.016a.76.76 0 0 0 .723 0l.028-.015.071-.041a16.975 16.975 0 0 0 1.144-.742 19.58 19.58 0 0 0 2.683-2.282c1.944-1.99 3.963-4.98 3.963-8.827a8.25 8.25 0 0 0-16.5 0c0 3.846 2.02 6.837 3.963 8.827a19.58 19.58 0 0 0 2.682 2.282 16.975 16.975 0 0 0 1.145.742ZM12 13.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" clip-rule="evenodd" />
        </svg>
        <span class="text-sm lg:text-base">Madrid</span>
      </div>
      <div class="flex gap-1 justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 lg:size-7">
          <path fill-rule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clip-rule="evenodd" />
        </svg>
        <span class="text-sm lg:text-base">604 369 473</span>
      </div>
    </div>
    <p class="flex justify-center items-center text-[11px] sm:text-[12px] text-white text-center font-light lg:text-sm">
  ...
  <div class="fixed z-30 bottom-0 flex gap-2 flex-col p-4 lg:p-8">
    <a href="#contacto" class="bg-white shadow-md rounded-full p-3" title="Contactanos" alt="Contactanos">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-primary-color hover:text-red-700 w-[24px] h-[24px] lg:w-[32px] lg:h-[32px]" focusable="true">
