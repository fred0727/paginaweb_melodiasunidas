...
<head>
    ...
    <title>Melodías Unidas | Profe Santiago</title>
...
<body>
    ...
    <section class="flex p-8 pt-14 w-full justify-center items-center flex-col gap-4 mb-6 sm:px-16 lg:hidden">
        ...
        <div class="flex justify-start items-center w-full gap-1" data-aos="fade-right" data-aos-duration="1000">
            ...
            <h3 class="font-medium text-start w-full font-['Oswald']">Santiago Andrés Medina Gómez</h3>
        </div>
        ...
        <p class="text-[12px] text-justify">
            En Polyphonic Studios, como director de audio, convierte cualquier idea en un paisaje sonoro que engancha desde el primer segundo. Y si hablamos de teatro, su trabajo como productor en obras como Test a Turing, Evoéh y La Patafomosis ha dejado al público totalmente atrapado.
        </p>
        <br>
        <p class="text-[12px] text-justify">
            Es un crack con programas como Logic Pro X, Pro Tools y Ableton, y usa estas herramientas para crear bandas sonoras que elevan cualquier proyecto, ya sea un videojuego, una peli o un corto.
        </p>
        <p class="text-[12px] text-justify">
            ¿Su filosofía? Que sus alumnos no solo aprendan música, sino que la vivan a su manera, disfrutando cada paso del camino. ¡Porque la música no se estudia, se siente!
        </p>
        <div class="flex w-[200px] h-[200px] mt-2 rounded-full" data-aos="fade-up" data-aos-duration="1000">
            <img src="./images/profes/santiago.jpeg" alt="Nuestro Profe" title="Nuestro Profe" srcset="" class="object-cover rounded-full w-[200px] h-[200px]" loading="lazy">
        </div>
    </section>
        ...
        <div class="flex flex-row gap-8 max-px-16 xl:max-w-[1920px]">
            <div class="flex flex-col">
                <div class="flex justify-start items-center w-full gap-1 mb-6" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <h3 class="font-medium text-start w-full font-['Oswald'] text-xl">Santiago Andrés Medina Gómez</h3>
                </div>
            ...
            <div class="flex w-full flex-col justify-center items-center gap-4">
                <div class="flex w-[300px] h-[300px] mt-2 rounded-full" data-aos="fade-up" data-aos-duration="1000">
                    <img src="./images/profes/santiago.jpeg" alt="Nuestro Profe" title="Nuestro Profe" class="object-cover rounded-full w-[300px] h-[300px]" loading="lazy">
                </div>
            </div>
        </div>
    </section>
